                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('profile') }}" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" name="alamat" value="{{ $user->alamat }}" required autocomplete="alamat">{{ $user->alamat }}</textarea>
